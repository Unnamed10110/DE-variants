 ...
 * @author USER- ACER
 */
public class DE_current_to_pbest {

    public static void main(String args[]) throws IOException {
        int kvariable = 1;
        long limite = 60 * 30;
        //paso 1: definir M, CR, NP, K y #generaciones
        float M = (float) 0.2;
        float CR = (float) 0.5;
        int NP = 20;
        ...
        //System.in.read();
                    ...
                    List<List<demand>> pbest = new ArrayList<>();
                    pbest.add(poblacion.get(0));
                    ...
                    while (cpTime & cpConvergencia) {
                        ...
                        for (int j = 0; j < poblacion.size(); j++) {
                            ...
                            if (gene < 5) {
                                ...
                                int ran = getRandomNumberInRange(0, pbest.size() - 1);
                                for (int k = 0; k < x1.size(); k++) {
                                    //System.out.println("ran: "+ran);
                                    //System.out.println("pbest: "+pbest.get(ran));

                                    mutant[k] = poblacion.get(j).get(k).getID() + M * (pbest.get(ran).get(k).getID() - poblacion.get(j).get(k).getID()) + M * (x1.get(k).getID() - x2.get(k).getID());
                                }
                            }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++                
                            //k variable
                            kvariable = getRandomNumberInRange2(1, kp);
