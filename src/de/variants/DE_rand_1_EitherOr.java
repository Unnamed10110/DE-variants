 ...
 * @author USER- ACER
 */
public class DE_rand_1_EitherOr {
        ...
        //System.in.read();
                    ...
                    while (cpTime & cpConvergencia) {
                        ...
                        for (int j = 0; j < poblacion.size(); j++) {
                            ...
                            Random randpf = new Random();
                            float rndpf = randpf.nextFloat();
                            if (rndpf < pf) {
                                ...
                                for (int k = 0; k < x1.size(); k++) {
                                    mutant[k] = poblacion.get(j).get(k).getID() + ki * (x1.get(k).getID() + x2.get(k).getID() - poblacion.get(j).get(k).getID());
                                }
                            }
...
//                        EnlaceRanurasFinal = asignarFS(kp2, EnlaceRanurasFinal, poblacion.get(i), directedGraphFinal);
//                        if (i == 1) {
